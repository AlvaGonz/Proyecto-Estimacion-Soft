        ...
        <div className="bg-white/5 backdrop-blur-2xl p-10 rounded-[3.5rem] border border-white/10 shadow-2xl space-y-10">
          ...
          <form onSubmit={handleLogin} className="space-y-8">
            <div className="space-y-6">
              ...
              <div className="space-y-2" role="group" aria-labelledby="role-label">
                <label id="role-label" className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-2">Rol de Acceso</label>
                <div className="grid grid-cols-2 gap-3">
                  <button 
                    type="button"
                    aria-pressed={role === UserRole.FACILITATOR}
                  ...
                  <button 
                    type="button"
                    aria-pressed={role === UserRole.EXPERT}
