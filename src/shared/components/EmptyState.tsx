    ...
    <div className="flex flex-col items-center justify-center p-12 text-center bg-slate-50/50 rounded-3xl border-2 border-dashed border-slate-200 animate-in fade-in duration-500">
      ...
      {action && (
        <button 
          ...
          className="bg-delphi-keppel text-white py-3.5 rounded-2xl font-black text-xs uppercase tracking-widest shadow-lg shadow-delphi-keppel/20 hover:scale-105 active:scale-95 transition-all btn-base"
        >
          {action.label}
        </button>
      )}
